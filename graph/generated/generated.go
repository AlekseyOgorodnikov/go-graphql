...
func (ec *executionContext) _Meetup_user(ctx context.Context, field graphql.CollectedField, obj *model.Meetup) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNUser2ᚖgithubᚗcomᚋjapygoᚋgraphqlᚋgraphᚋmodelᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_meetups(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNMeetup2ᚕᚖgithubᚗcomᚋjapygoᚋgraphqlᚋgraphᚋmodelᚐMeetupᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _User_meetups(ctx context.Context, field graphql.CollectedField, obj *model.User) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Meetup)
	fc.Result = res
	return ec.marshalOMeetup2ᚕᚖgithubᚗcomᚋjapygoᚋgraphqlᚋgraphᚋmodelᚐMeetupᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNMeetup2ᚕᚖgithubᚗcomᚋjapygoᚋgraphqlᚋgraphᚋmodelᚐMeetupᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Meetup) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNMeetup2ᚖgithubᚗcomᚋjapygoᚋgraphqlᚋgraphᚋmodelᚐMeetup(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNMeetup2ᚖgithubᚗcomᚋjapygoᚋgraphqlᚋgraphᚋmodelᚐMeetup(ctx context.Context, sel ast.SelectionSet, v *model.Meetup) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalNUser2ᚖgithubᚗcomᚋjapygoᚋgraphqlᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v *model.User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalOMeetup2ᚕᚖgithubᚗcomᚋjapygoᚋgraphqlᚋgraphᚋmodelᚐMeetupᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Meetup) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
